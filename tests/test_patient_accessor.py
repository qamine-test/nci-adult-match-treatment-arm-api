...
class PatientAccessorTests(unittest.TestCase):
    ...
    def test_get_patients_by_treatment_arm_id(self, mock_requests):
        ...
        result = patient_accessor.get_patients_by_treatment_arm_id(treatment_id)

        mock_requests.get.assert_called_once_with(TEST_PATIENT_API_URL+'/by_treatment_arm/'+treatment_id)
